...
$(function() {
     ...
     */
        it('Visibility changed when menu icon is clicked', function () {
     ...
     */
        ...
        it('There is at least a single .entry element within the .feed container', function (done) {
            /*Laod the check there is more than 0 content to make sure it works*/
     ...
     describe('New Feed Selection', function () {
         ...
         beforeEach(function (done) {
             /*First we clear all possible original feed */
             $('.feed').empty();

             /*Laod the first time and save the text*/
             loadFeed(0, function () {
